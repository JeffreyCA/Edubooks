...
public class OrderCell extends ListCell<Order> {
	...
	final int DATE_FONT_SIZE = 16;
	final int PRICE_FONT_SIZE = 18;

	final int DATE_BOX_WIDTH = 145;
	...
	public void updateItem(Order o, boolean empty) {
		...
		if (o != null) {
			...
			date.setFont(new Font(DATE_FONT_SIZE));
			time.setFont(new Font(DATE_FONT_SIZE));
			...
			date_box.setMinWidth(DATE_BOX_WIDTH);

			// Item counter
			number_items.setFont(new Font(DATE_FONT_SIZE));
